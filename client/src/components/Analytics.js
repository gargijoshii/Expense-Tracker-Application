            ...
            {categories.map((category) => {
              ...
              return (
                amount > 0 && <div className="category-card">
                  <h5>{category}</h5>
                  <Progress  strokeColor ="#F7418F" percent={((amount / totalIncomeTurnover) * 100).toFixed(0)} />
                </div>
              );
            })}
          </div>
          ...
          <div className="expense-category-analysis">
            ...
            {categories.map((category) => {
              ...
              return (
                 amount > 0 && <div className="category-card">
                  <h5>{category}</h5>
                  <Progress strokeColor="#F7418F"percent={((amount / totalExpenseTurnover) * 100).toFixed(0)} />
                </div>
              );
            })}
          </div>
